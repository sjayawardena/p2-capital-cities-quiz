...
let correctAnswerAlert = document.getElementById("correct-answer-popup"); //variable for displaying correct answer pop-up
let incorrectAnswerAlert = document.getElementById("incorrect-answer-popup"); //variable for displaying incorrect answer pop-up
